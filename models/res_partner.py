...
class ResPartner(models.Model):
    ...
    name = fields.Char(
        ...
        required=False,
        store=True)
    #switch_names = fields.Boolean(string = "Switch lastname and firstname!", default = False)
    @api.model
    ...
    # @api.onchange('switch_names')
    # def switch_names1(self):
    #     fname = self.firstname
    #     self.firstname.write({'firstname': self.lastname})
    #     self.lastname.write({'lastname': fname})
    #     return True
